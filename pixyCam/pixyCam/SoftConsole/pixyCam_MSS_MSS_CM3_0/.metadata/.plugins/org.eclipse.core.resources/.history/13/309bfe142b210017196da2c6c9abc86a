...
BUILDCMD = arm-none-eabi-gcc -mthumb -mcpu=cortex-m3  -L"N:\eecs373\project\pixyCam\pixyCam\SoftConsole\pixyCam_MSS_MSS_CM3_0\pixyCam_MSS_MSS_CM3_0_hw_platform\Debug" -TN:\eecs373\project\pixyCam\pixyCam\SoftConsole\pixyCam_MSS_MSS_CM3_0\pixyCam_MSS_MSS_CM3_0_hw_platform\CMSIS\startup_gcc\debug-in-actel-smartfusion-esram.ld -Wl,-Map=$(EXECUTABLE).map -Xlinker -gc-sections 
SHELL := cmd.exe
EXECUTABLE := pixyCam_MSS_MSS_CM3_0_app
